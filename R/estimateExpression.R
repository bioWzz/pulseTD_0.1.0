...
#'
#' This function is used to calculate the expression value of the gene, using GenomicAlignments based software <doi:10.1371/journal.pcbi.1003118>.
#' It includs total exon expression values, total intron expression values,
#' labeled exon expression values, and labeled intron expression values.
#'
