...
#' including transcription parameters, degradation parameters and processing parameters.
...
#' including the expression of pre-mRNA and the expression of total mRNA.
